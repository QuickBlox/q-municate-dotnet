...
namespace QMunicate.ViewModels
{
    public class PrivateChatViewModel : ViewModel
    {
        ...
        private async void PrivateChatManagerOnOnIsTyping(object sender, EventArgs eventArgs)
        {
        ...
        private async void PrivateChatManagerOnOnPausedTyping(object sender, EventArgs eventArgs)
        {
            var dispatcher = CoreApplication.MainView.CoreWindow.Dispatcher;
            await dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
             {
        ...
        private async void ChatManagerOnOnMessageReceived(object sender, Message message)
        {
            ...
            await CoreApplication.MainView.CoreWindow.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, CheckIsMessageSendingAllowed);
        }
